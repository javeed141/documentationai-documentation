...
* At present, there are two request workflows for Goodwill points and Retro-transaction claims.  In the future releases, all the existing Orgs from the older workflows will be migrated to the newer workflow.
