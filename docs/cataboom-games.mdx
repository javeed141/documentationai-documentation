...
<Iframe src="http://www.youtube.com/watch?v=XVqVOMFpr-8" title="Games Demo" width="100%" height="400" />

## Sample use cases:

1. Lifestyle and Fashion Retail - Provide experience-led loyalty
...
2. Supermarkets  and Grocery Chains - Drive traffic and reward habits
...
3. Fuel Retail - Cross-sell and increase wallet share
...
<Image width="45% " src="https://files.readme.io/308d1b2-Screenshot_2023-08-14_at_4.35.06_PM.png" />
...
<Image width="65% " src="https://files.readme.io/0534335-image5.png" />
...
<Image width="50% " src="https://files.readme.io/afa1c38-image14.png" />
...
<Image src="https://files.readme.io/5963d8c-image8.png" />

4. Click **Campaigns** to create new games.  You can also search for existing games.

<Image width="75% " src="https://files.readme.io/5b049e2-image1.png" />
...
<Image width="75% " src="https://files.readme.io/18c6ef9-image6.png" />

7. Click **Create**.\
   The campaign is created.
8. Configure the game as required.

<Image width="60% " src="https://files.readme.io/1771f22-image9.png" />

<Image width="65% " src="https://files.readme.io/bbad9db-image13.png" />

<Image width="65% " src="https://files.readme.io/c4f0551-image11.png" />

<Image width="65% " src="https://files.readme.io/b6109cc-image10.png" />

<Image width="65% " src="https://files.readme.io/7b5c9db-image12.png" />

Once you click on the game URL, the following screens will appear based on the configuration:**

Optional screen:

<Image width="300px" src="https://files.readme.io/d5d0855-image2.png" />

Game screens

<Image width="300px" src="https://files.readme.io/7e83b10-image15.png" />

<Image width="300px" src="https://files.readme.io/9e34b6f-image4.png" />

Fulfillment form to share the rewards

<Image width="300px" src="https://files.readme.io/26ea31a-image7.png" />

<Image width="60% " src="https://files.readme.io/2ba12a9-image16.png" />
...
13. Is middle layer setup required every time a new game is set up as the event_name will be changed with each game or will it be the same in every game?
