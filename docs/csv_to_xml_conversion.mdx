...
3. In the **CSV-To-XML-Converter** block, enter the conversion details. See [CSV-To_XML-Converter](https://docs.capillarytech.com/docs/configure-actions#csv-to-xml-converter).
