...
<Image width="70% " src="https://files.readme.io/639372d-homepage.png" />

2. Click the ellipsis menu on the Customer Single View (CSV) page.

<Image width="70% " src="https://files.readme.io/fbc60cd-menu.png" />

3. Click **Goodwill request**

<Image width="300px" src="https://files.readme.io/fc6ee56-image.png" />

4. Click **Coupons**

<Image width="300px" src="https://files.readme.io/8253918-coupons.png" />

5. From the **Select coupon** dropdown, choose any coupon of your choice.

<Image width="300px" src="https://files.readme.io/2b091a6-coupon_select1.png" />

6. From the **Reason** dropdown, choose the appropriate reason for issuing the coupon.

<Image width="300px" src="https://files.readme.io/6b04b61-reason.png" />

7. In the **Comments** section, enter a note for issuing the goodwill coupon.

<Image width="300px" src="https://files.readme.io/be119a0-Comment.png" />

8. Click **Send request**.

<Image width="250px" src="https://files.readme.io/0532d8a-send_req.png" />

A coupon is issued to the customer.

<Image width="350px" src="https://files.readme.io/d292d2d-coupon_success.png" />
...
<Image width="300px" src="https://files.readme.io/76fa354-image.png" />

5. Enter the points you want to add in the **Points to be added** field.

<Image width="300px" src="https://files.readme.io/bf0a3f1-image.png" />

6. From the **Program** dropdown, choose the appropriate program.

<Image width="300px" src="https://files.readme.io/70a8ef1-image.png" />
...
<Image width="250px" src="https://files.readme.io/6e488b8-image.png" />

Points have been issued to the customer.

<Image width="350px" src="https://files.readme.io/adaf036-image.png" />
