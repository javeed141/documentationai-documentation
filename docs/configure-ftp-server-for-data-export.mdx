...
4. Enter the following details:
   ...
   <Image width="50% " src="https://files.readme.io/2b5fc46-Sample_config.png" />
...
<Image width="50% " src="https://files.readme.io/bb8deed-check_port.png" />

2. Run the command `telnet <hostname> <port>`.

<Image width="50% " src="https://files.readme.io/827c7c6-check_whitelist.png" />
