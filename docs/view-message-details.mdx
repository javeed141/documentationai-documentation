...
<Image width="80%" src="https://files.readme.io/1291da4-8ZTt4MX7AHQKTq9O26vs8SlL-WiA11v6HA.png" />
...
<Image width="smart" src="https://files.readme.io/e0d4e39-sKWVlEOUiTO8Y7AHciv-cER5qJEZ2ZShcA.png" />
...
* For transactional emails, if an email address is marked as hardbounced, delivery is blocked. You can use  **[Email whitelisting](https://docs.capillarytech.com/docs/configure-email-settings#configure-email-whitelisting)** to allow delivery for testing purposes. If another hardbounce occurs, the email address is blocked again.
...
* Status of the uploaded files and option to download the issues
  ...
  <Image src="https://files.readme.io/b5b343d-Audience_details.gif" />
...
<Image src="https://files.readme.io/155e3c4-Additional_details.png" />
...
<Image alt=" " src="https://files.readme.io/1d0c501-Recurring_message_alert.png" />
