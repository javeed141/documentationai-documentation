...
<Image src="https://files.readme.io/8748c52-Open_report.png" />

3. Click the **More** Options icon > **Edit**.

<Image width="35% " src="https://files.readme.io/c2d8bb2-edit_report.png" />

4. On the **Edit report** screen, click **Next**.
5. Click **+Add/remove charts** and select the chart you want to add/ remove.

<Image width="25% " src="https://files.readme.io/03c2534-Add_Chart.png" />

<Image src="https://files.readme.io/c2c9124-Select_Chart.png" />

6. Click **Done**.
7. To align the charts, drag a chart and drop it at the desired position.

<Image src="https://files.readme.io/bcd5758-Drag_Charts.gif" />
...
<Image width="75% " src="https://files.readme.io/fe9ef13-Edit_URL.png" />
...
<Image src="https://files.readme.io/45dcb15-DB_URL.png" />
...
<Image src="https://files.readme.io/41f42b1-Delete_Report.png" />
