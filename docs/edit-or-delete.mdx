...
<Image src="https://files.readme.io/c2d8bb2-edit_report.png" alt="" />

4. On the **Edit report** screen, click **Next**.
5. Click **+Add/remove charts** and select the chart you want to add/ remove.

<Image src="https://files.readme.io/03c2534-Add_Chart.png" alt="" />
...
<Image src="https://files.readme.io/fe9ef13-Edit_URL.png" alt="" />
