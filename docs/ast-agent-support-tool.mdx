...
* **Extract Scheduling and Monitoring:** Supports creation and scheduling of extracts directly from within the AST application, enabling agents to monitor and track SLA performance for various SRs.
