...
<Image width="50% " src="https://files.readme.io/5b6f1ed-Enable_SSO.png" />
...
<Image width="50% " src="https://files.readme.io/4d5eb2d-SAML.png" />

**Note:** Capillary supports SSO with SAML 2.0 authentication only (SAML 2.0 IdP).

2. Click **Next**.
3. In the **Configure SAML 2.0 IdP** page, enter the following details:
   * **Name:** Enter the customer name.
   * **Prerequisite:** An attribute must be defined and mapped. See step 5 for information on attribute and mapping.\
...
<Image src="https://files.readme.io/a4dc3c1-Attributes.gif" />
...
<Image src="https://files.readme.io/1d7a707-Profile_Attributes.gif" />
...
<Image src="https://files.readme.io/2c79f0e-Mapping.gif" />
...
<Image src="https://files.readme.io/15f2f6a-Routing_rules.gif" />
...
<Image width="30% " src="https://files.readme.io/a5697f3-SSO_login.png" />
