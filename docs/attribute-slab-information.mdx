...
<Image src="https://files.readme.io/9d1e8f4-image.png" />
...
| Example1: As a brand, we have a tired based loyalty program where the tiers are silver, gold and Platinum. We have separate points allocation strategies for tiers respectively, thus write a condition to allocate points for a customer in Gold Tier. |
| :--- |
| Profile -> currentCustomer slabName -> GOLD Rule expression -> currentCustomer.slabName==“Gold” |
...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rule : currentCustomer.slabName=="Shine" and  and (currentCustomer.currentPoints>1000)                                                                                                                   |
...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Expression: ((currentCustomer.slabNumber==3) and  and (currentTxns.value)&gt;=30 and  and (currentTxns.value&lt;600))                                                                                                |
...
| :------------------------------------------------------------------------------------------------------------------------------------------ |
| ((currentCustomer.slabNumber &gt; currentCustomer.initialSlabNumber) and  and (currentCustomer.slabNumber == 3))                                     |
...
| :---------------------------------------------------------------------------------------------------------------------------------- |
| currentTxn.value>100 and  and (currentCustomer.slabName.matches("SILVER"))                                                                  |
