...
3. **Why might the View Report button be disabled after a journey goes live?**\
   The button may be disabled if the ETL Sync is still in progress. The system takes 24 hours after the journey goes live to generate the report.
...
5. **How to delete a journey?**
   ...
   No, you cannot delete a journey. Instead, you can stop or pause it. For more information refer to [Edit a live journey](https://docs.capillarytech.com/docs/manage-live-journey-versions#/to-edit-a-live-journey-perform-the-following).
