...
1. From the Request Workflows list, navigate to **Goodwill_points** > **Edit request workflow mapping**.
...
<Image src="https://files.readme.io/c67849f-goodwill_points3.gif" width="1920" height="1080" alt="" />
