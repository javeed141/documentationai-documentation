...
<Image width="75% " src="https://files.readme.io/ac443c4abb325fc75272b2ac70af025adbb218bdf44d7913b003add6bbd2fe1f-C_v3.png" />
...
| Invalid Workspace ID                | Workspace ID is incorrect. Verify the workspace ID by sending a[GET request to the workspaces](https://docs.capillarytech.com/update/reference/get-workspaces-diy-connectplus-template#/)  API. |
