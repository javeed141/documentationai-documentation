...
1. **Can I create streaks based on the cyclic calendar window type?**\
   As of now, a streak can be created only of fixed calendar window type. This means that, for all the users of the streak, the streak will start and end on the same date.
...
<Image width="70% " src="https://files.readme.io/1e0c132-Screenshot_2024-04-09_at_8.58.02_PM.png" />
...
2. **What is the difference between a continuous streak and non-continuous streak?**\
...
5. **I cannot see the name of the streak definition/levels in the UI, however, it seems that I have to write rules based on the exact level name. How does this work?**\
   ...
   Until then, the name of a streak level will be "streak name_X". Say, you have 2 levels in your streak and the name of the streak is ABC.
