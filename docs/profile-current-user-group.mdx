...
| :------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| extField*ug*`extfieldname` | Access extended field values for the user group. Replace "extfieldname" with the actual extended field name configured for your organization (e.g., extField_ug_primary_user, extField_ug_registration_date"). |
