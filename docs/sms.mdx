...
* Register message templates under one of the three approved categories:
  ...
  * Service Explicit
  * Service Implicit\
    For more information refer to [Create SMS Template for Indian Orgs (as per TRAI Regulations)](https://docs.capillarytech.com/docs/configure-sms-template-content#create-sms-template-for-indian-orgs-as-per-trai-regulations) documentation.

For non-Indian organizations, the process is simpler, involving direct content creation without DLT compliance. For more information refer to [Create SMS template for other Orgs](https://docs.capillarytech.com/docs/configure-sms-template-content#create-sms-template-for-non-indian-organizations) documentation.
