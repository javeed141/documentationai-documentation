...
| Double | Choose this to capture a double data type. * Double is a 64-bit floating value with precision up to 15 decimal places_. |
...
2. In the events page, use the toggle switch and add the desired attributes to unique key. You can do this using API or from the UI.  To add it from the UI,
   ...
   1. Enable the **Is part of unique key** switch.
      ...
      <Image src="https://files.readme.io/3a84974-Uniqueness_check.png" />
      ...
      **Unique key format**: EventName_Customerid_Attribute1*Attribute2*....
      **Unique key**:  md5 hash generated from combining the event name, customer identifier, and additional attributes in the EventName_Customerid_Attribute1_Attribute2 format.
...
<Image width="20% " src="https://files.readme.io/16b3b8f-Behaviorial_event_fc.png" />
...
1. On the Behavioral Events home page, in the **All Events** tab, search for the event that needs testing and click on the event name.
   ...
   <Image width="500px" src="https://files.readme.io/fc0063b-BE_home_events.png" />

The events attribute page opens.

<Image width="500px" src="https://files.readme.io/c831e05-event_attributes.png" />
...
3. Open an editor like Notepad to edit the payload. Fill in the correct values of the fields.
   ...
   <Image src="https://files.readme.io/c149d34-code_refined_1.jpg" />
...
<Image src="https://files.readme.io/ee6d461-Webhook.png" />
...
<Image width="600px" src="https://files.readme.io/42d35e9-validate.png" />
...
8. Click  **Publish** to publish the event.
   ...
   <Image width="500px" src="https://files.readme.io/eb38a91-image_2.png" />
...
<Image width="500px" src="https://files.readme.io/ad90225-image_3.png" />
