...
<Image src="https://files.readme.io/bbea5fd34238dfc74570f332bf6c1988ba1aa1b2c362f9d0dcb28970e4bce0e5-image.png" alt="" />

<Image src="https://files.readme.io/71c191a2fcf87db393fe56ec7e7b175ce38db19e563e927c6c5a524fc800a140-Frame_6.png" alt="" />
...
<Image src="https://files.readme.io/b01ab7c023d012f9a6977b676a69590c8b81344cf05f6966318063e5e145a452-image.png" alt="" />

<Image src="https://files.readme.io/6e124bbc004da21125c4b62defc8daff72cf62019d7db5d2d9f6534336a9fdb5-Frame_7.png" alt="" />
...
<Image src="https://files.readme.io/7cb5879b33121f90199a41f041b220307de4444ef24377ed9f4296a36cf21114-image.png" alt="" />

<Image src="https://files.readme.io/a15e28916663c8313777be6cab1cef781b55e5592d20c0f7fe241e10b440c780-Frame_8.png" alt="Customer tracker with the condition `(A AND B) OR C`" />
...
3. [Create and configure](https://docs.capillarytech.com/docs/trackers-1#creating-trackers) all the required criteria trackers.
   ...
   <Image src="https://files.readme.io/bfd4bb6d16cf7878673beae806aee92fc930dee88ccd6691590266a4cb97ca39-FlightTrackerEdited_-_Made_with_Clipchamp.gif" alt="Creating a flight tracker" />

   <Image src="https://files.readme.io/d851b069e1b9648060ee2509b57bb5fb5ba1b6da78f52c7598354af98b6fd483-HotelTracker_-_Made_with_Clipchamp.gif" alt="Creating a hotel stay tracker" />
...
3. [Create and configure](https://docs.capillarytech.com/docs/trackers-1#creating-trackers) all the required criteria trackers.
   ...
   <Image src="https://files.readme.io/838c3084505ab0d7454934156989917f0956a2ade15a8e86a0ed307dd1e855c4-GymVisits_-_Made_with_Clipchamp.gif" alt="Creating a workout tracker" />

   <Image src="https://files.readme.io/d181eb89689522e3bf1c317a98d0d2b34c05a19ca510a37c20beb8a98daf3016-GymPurchases_-_Made_with_Clipchamp.gif" alt="Creating a purchase tracker" />
4. Navigate to the **Advanced settings** for the program to define conditions for a tier upgrade.
5. Select **+Tracker** to add a new tracker and select the **Tracker**, **Tracking period** and the **Upgrade type**.
...
3. [Create and configure](https://docs.capillarytech.com/docs/trackers-1#creating-trackers) all the required criteria trackers.
   ...
   <Image src="https://files.readme.io/e31665a87b86e8883b2dc3ace472b1dbe9872bbbd0462501f799b507ebc2f8f7-5purchases_-_Made_with_Clipchamp.gif" alt="Creating a customer purchase tracker" />

   <Image src="https://files.readme.io/04459f806f6436c80264f903bfd067f5a8b04c7ccd32faa00500cfc7505b1e7c-1000purchase_-_Made_with_Clipchamp.gif" alt="Creating a tracker for purchases over $1000" />
4. Navigate to the **Advanced settings** for the program to define conditions for a tier upgrade.
5. Select **+Tracker** to add a new tracker and select the **Tracker**, **Tracking period** and the **Upgrade type**.
