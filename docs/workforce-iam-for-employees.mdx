...
* **Login and Password**: Employees can log in using their email ID and password.
...
* **Mobile APIs auth service**: End customer apps can be integrated using Mobile APIs auth service, using username and password/OTP, till username and password or Custom and non-standard (non oAuth2 or OIDC) authorization. No social login options are supported.
