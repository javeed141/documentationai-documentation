...
1. Activate/Deactivate a milestone
   ...
   2. A deactivated milestone can be re-activated again as long as the milestone is not yet over.
      ...
      <Image src="https://files.readme.io/5804999-Screenshot_2024-08-05_at_6.02.38_PM.png" alt="" />
...
<Image src="https://files.readme.io/ef4cef1-New_milestone.png" alt="" />

2. Select **Build from scratch** and click **Next**.

<Image src="https://files.readme.io/82d2cb9-Screenshot_2024-04-09_at_3.22.20_PM.png" alt="" />
...
<Image src="https://files.readme.io/58a192c-Screenshot_2023-07-21_at_3.19.31_PM.png" alt="" />
...
<Image src="https://files.readme.io/74ea63b-Screenshot_2024-04-09_at_3.37.48_PM.png" alt="" />
...
<Image src="https://files.readme.io/bb50d86-Screenshot_2024-04-09_at_3.39.47_PM.png" alt="" />
...
<Image src="https://files.readme.io/e095261-Screenshot_2024-04-09_at_3.38.00_PM.png" alt="" />
...
1. Go to the **Customer enrolment** section on the **New milestone** page.
   ...
   <Image src="https://files.readme.io/7819aaf176d1adaaf149dab0efe80ded4c83e9e7823c462a54bc8707d71710a5-image.png" alt="" />
...
<Image src="https://files.readme.io/1d7b553cb547302280d41192ee7712f25106ba9d98bce2412de2ceb62f02c881-image.png" alt="Selecting an audience group" />

<Image src="https://files.readme.io/4dd927bd4530b78b89fc489fbf49483fc723962b10f6cc45f86592bdf20d1d41-image.png" alt="Uploading a CSV of audience with target values" />
...
* Target 3: Only those customers who achieved Target 2.
  ...
  <Image src="https://files.readme.io/f1d6695-Screenshot_2023-11-26_at_7.41.09_PM.png" alt="" />
  ...
  <Image src="https://files.readme.io/b3108ff-Screenshot_2023-11-26_at_7.51.13_PM.png" alt="" />
...
1. Navigate to the Milestone listing page and select the **Edit** icon for the target.
   ...
   <Image src="https://files.readme.io/960747af8c38defde895f1641baf8218f976936322c5b2a06d5048da4b38e352-image.png" alt="" />
2. Select **Customer enrolment** from the left menu to edit the customer enrolment for the milestone.

   <Image src="https://files.readme.io/67ea1d7422d8d4f95959b5684a1a2e54e3d41c447ba649d631a9e3012b2be5aa-Screenshot_2025-04-10_at_1.52.30_PM.png" alt="" />
...
<Image src="https://files.readme.io/caa2a868bb45e1000ccef6baa15709bffec7cfe17f59e2a4bbedc4192c415eec-image.png" alt="" />
...
3. Select the customer activity to achieve the target using the drop down under the **What should the customer do to achieve the target?** section. Refer to the section on [Customer Activities ](https://docs.capillarytech.com/docs/milestones-new-flow#customer-activities)for more information on the configurations for each type of customer activity.
   ...
   <Image src="https://files.readme.io/fa881f68ead16364fea5ec8e1a1f476e0931a708139fbde4f595fb81c8fdf694-image.png" alt="" />
4. Configure the target activity KPI and target values under the **What should the customer do to achieve the target?** section. Refer to the section on [Tracking Configurations](https://docs.capillarytech.com/docs/milestones-new-flow#tracking-configurations) for more information on the configurations for each type of customer activity.
   ...
   <Image src="https://files.readme.io/742770dea0985976fe9000e1cdfbbf49c95b11b32deb08ece4808b761f715ea5-image.png" alt="" />
5. Configure the scope for the target under the **Scope of`<target name>`** section. Refer to the documentation on [filter activity](https://docs.capillarytech.com/docs/milestones-new-flow#filter-activity) for more information on configuring the scope.
   ...
   <Image src="https://files.readme.io/25879d1fa7d95d9ee6f95129373a19c935e7c3ff92129ed9cf6a07e15d62119a-image.png" alt="" />
...
<Image src="https://files.readme.io/c0dc4eadfd4098178d33485a6e77df0fbc3c5bb00211916c30b1f41b6967ac75-Milestone_Setup_Process_Guide.gif" alt="" />
...
<Image src="https://files.readme.io/41898012bf93e3e5f21a7f3991baddcd801af065c50e17272cfe5cdf84bec760-Subtarget_1.png" alt="" />
...
<Image src="https://files.readme.io/c595564fc9b2b08341a48cf71af34cb2d4317518f555a00c1dbc5f170ecbaae9-Screenshot_2024-11-04_at_12.35.08_PM.png" alt="" />

When the configurer clicks on the "advanced settings" on the top-right corner, the following page opens up:

<Image src="https://files.readme.io/36f8641de1cbf811967494dda8950df413be4ce85155abc27d41c69488eb0457-Screenshot_2024-11-04_at_12.34.57_PM.png" alt="" />
...
<Image src="https://files.readme.io/5a9a05e8b941c6dfad693329a8c15a88d50ee86b2ac4a4f3b8f0e4ded98a7aa7-milestones_view_-_Made_with_Clipchamp.gif" alt="" />
...
<Image src="https://files.readme.io/adbd358f077e270ffe3d48803e092e85e447f8ea0f5a421d8ab39ed04af166c3-Screenshot_2024-09-24_at_10.59.54_AM.png" alt="" />
...
<Image src="https://files.readme.io/1512bf0-Screenshot_2024-08-05_at_3.58.13_PM.png" alt="" />
...
2. Select the <img src="https://cdn-icons-png.flaticon.com/512/158/158384.png" alt="Gear Icon" width="20" height="20" /> icon in the upper-right corner.
   ...
   <Image src="https://files.readme.io/8045437b50eff44af4518e17644e6ea9e05f0ecc1cfb1fe267dc4ad41e272730-image.png" alt="" />
...
* **When the setting is enabled**, the earned points are not deducted in the current cycle (January). In the subsequent cycle (February), the milestone starts at a negative (-) ₹3,000 for the customer. The customer must spend ₹8,000 (₹5,000 + ₹3,000) to be eligible to earn points in February.
  ...
  <Image src="https://files.readme.io/d380275f33df212d61fe41e4931980d765e5d8a1691a4ad82d6caa125fbe1c96-Return_Settings.png" alt="When “Adjust milestone values in subsequent period/cycle within milestone” is enabled" />
...
<Image src="https://files.readme.io/0ee1350d24c591414b89852969368a1752e7a00e76b1386931b94848b9ebbbf9-image.png" alt="" />
...
2. Select the appropriate radio button under **For line item based milestones, if return is on transaction amount**.
   ...
   <Image src="https://files.readme.io/f978889bcdbf9a15ecdb843f688cc1a122e907fd8004213b9def09ad55858a3e-image.png" alt="" />
3. Select **Save** to save the changes.
...
<Image src="https://files.readme.io/7ed9ba632a8b2edbaa3db55f729cd7226376d301a31fc6a60fad8c7ff0b5e679-Offset.png" alt="When “Offset days for sales calculation” is > 0" caption="When “Offset days for sales calculation” is > 0" />
...
2. Enter the number of days under **What is the delay in sync between Sales data and Capillary platform?**.
   ...
   <Image src="https://files.readme.io/e12222e4c2da1dcb4ab2b058ad19f03008718f484f76f41f1b688cb32b5f29f8-image.png" alt="" />
3. Select **Save** to save the changes.
...
* **When the setting is enabled**, the previous transactional and [behavioural events](https://docs.capillarytech.com/docs/setup-test-behavioral-events) are not considered, and the progress is not added. [Customer activities](https://docs.capillarytech.com/docs/milestones-new-flow#customer-activities) (transactional and behavioural events) will begin tracking from the enrolment date.
  ...
  <Image src="https://files.readme.io/aa44c2bb91f85e0eb75c40cdb5ca49c78c1b184ec2307b3c779f396622068cd6-Enrolment_date.png" alt="When “Track customer activity from their enrolment date” is disabled" />
...
2. Enable the toggle under **Track customer activity from their enrolment date**
   ...
   <Image src="https://files.readme.io/c032459af48c4bf9f6d4a20175c91a1310980ac1f281d239c987e36f06f09295-image.png" alt="" />
3. Select **Save** to save the changes.
...
2. Enable the toggle under **Leaderboard for milestone**
   ...
   <Image src="https://files.readme.io/2569b48d678518fb14aba9c8b2931807edb2972d8091e022af3618f3abad5836-image.png" alt="" />
3. Select **Save** to save the changes.
