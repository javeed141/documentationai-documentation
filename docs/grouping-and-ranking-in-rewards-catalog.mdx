...
For example, in the below screenshot, Recommended Products have a higher priority than Home and Kitchen Category. Within each defined group, rewards are sorted based on their rank.

<Image src="https://files.readme.io/b58d172-image2.png" />
