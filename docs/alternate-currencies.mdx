...
<Image width="80% " src="https://files.readme.io/d7eeb8b-Screenshot_2024-02-28_at_3.45.26_PM.png" />
...
<Image width="60% " src="https://files.readme.io/29c8219-Desktop_-_493.jpg" />

<Image width="60% " src="https://files.readme.io/f4dc0f7-Frame_717605.jpg" />
...
6. Enter the required details needed to create the currency:
   ...
   3. Activate/Deactivate: Similar to promotions, an active/inactive status can be assigned to Alternate Currencies. This is an editable feature, so this can be updated as and when needed.
   ...
   7. Return of Alternate currency: If a brand desires, the return property (return and return re-evaluation) can be revoked for an alternate currency. This is an irreversible property once created.
...
<Image width="60% " src="https://files.readme.io/fdbe716-Screenshot_2024-08-07_at_12.41.46_PM.png" />
...
<Image src="https://files.readme.io/db33b61-Desktop_-_409.jpg" />
...
Since Alternate Currencies function in parallel with points, brands can distribute them like points through loyalty programs and loyalty promotions. These can't distributed through Engage+ as of now.
...
<Image width="60% " src="https://files.readme.io/ac710fd-24471_frame.jpg" />

<Image width="60% " src="https://files.readme.io/bea8fcc-25127_frame.jpg" />
...
<Image width="60% " src="https://files.readme.io/611b4f9-25791_frame.jpg" />
...
7. Click on "Add new tracker".
   ...
   3. However, to create a tracker based on an alternate currency, the corresponding currency has to be selected in the tracked entity. Say, there are 2 alternate currencies (stars, tier points) present in your program:
      1. Then both the stars and tier points will appear as options in the "tracked entity"
8. Click on "Save" to create the tracker

   <Image width="80% " src="https://files.readme.io/60a5a80-Milestone_-_Option-2_1.jpg" />
...
<Image src="https://files.readme.io/5ae5ded-Screenshot_2024-04-19_at_3.52.49_PM.png" />
...
<Image width="95% " src="https://files.readme.io/5b2dd76-Screenshot_2024-04-19_at_2.02.19_PM.png" />

**Preview of using the above tracker for renewal check:**

<Image width="95% " src="https://files.readme.io/0410ae7-Screenshot_2024-04-19_at_2.03.12_PM.png" />
...
* A new alternate currency called "Pebble" can be created in other orgs with the same name, but all of them work independently and confined only to their respective orgs.
...
3. Can I distribute alternate currencies from any customer activities?
   1. Yes, these can be distributed from any customer activity like add transaction, target completed, generic events, etc. making the distribution seamless and universal.
