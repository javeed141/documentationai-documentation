...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [coupon_event_type](https://docs.capillarytech.com/docs/dimension-tables#redeemed-status-redeemed_status)                                                       | Identifier for the coupons event type, such as issuance or redemption.                                     |
...
| [coupon_series](https://docs.capillarytech.com/docs/dimension-tables#coupon-series-coupon_series)                                                                | Coupon series against which the coupon has been issued or redeemed.                                        |
| [expiry_date](https://docs.capillarytech.com/docs/dimension-tables#date)                                                                                         | Date when the coupon is set to expire.                                                                     |
| [issual_date](https://docs.capillarytech.com/docs/dimension-tables#date)                                                                                         | Date when the coupon has been issued.                                                                      |
| [issual_time](https://docs.capillarytech.com/docs/dimension-tables#time)                                                                                         | Time when the coupon has been issued.                                                                      |
| [issual_type](https://docs.capillarytech.com/docs/dimension-tables#coupon-issual-type-coupon_issual_type)                                                        | Captures the issuance type, with possible values such as store or customer.                                |
| [campaign_group](https://docs.capillarytech.com/docs/dimension-tables#campaign-group)                                                                            | Identifier for the campaign group associated with the coupon issuance.                                     |
...
| [entry_type](https://docs.capillarytech.com/docs/dimension-tables#entry-type-entry_type)                                                                         | Captures whether the coupon entry is manual or through Intouch.                                            |
| [latest_updated_date](https://docs.capillarytech.com/docs/dimension-tables#date)                                                                                | Latest date when the data is updated.                                                                      |
| [latest_updated_time](https://docs.capillarytech.com/docs/dimension-tables#time)                                                                                | Latest time when the data is updated.                                                                      |
| [is_coupon_redemptions_active](https://docs.capillarytech.com/docs/dimension-tables?isFramePreview=true#coupon-redemption-status-is_coupon_redemptions_active) | Indicates whether redemptions are currently enabled for this coupon.                                       |
| [is_coupon_issued_active](https://docs.capillarytech.com/docs/dimension-tables?isFramePreview=true#coupon-status-is_coupon_issued_active)                      | Indicates whether the issued coupon is currently active.                                                   |
