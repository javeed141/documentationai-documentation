...
<Image src="https://files.readme.io/7224e20-Access_control.png" />
...
<Image width="55% " src="https://files.readme.io/2c25ad3-Resource.png" />
...
4. In the **Group permission**, select the  and set the permission for **Data API** and **Config API** as follows:
   ...
   * **Write**: Access to POST API endpoints. For example, an access group with Write access to Coupon resource will have access to all Coupon POST API endpoints.
     ...
     <Image src="https://files.readme.io/b8e5bcb-Search_Resource.gif" />
...
<Image src="https://files.readme.io/8f7fec4-Create_Access_Group.gif" />
...
<Image src="https://files.readme.io/19c49e7-Change_default_group.gif" />
...
<Image src="https://files.readme.io/d509d2b-Add_store.png" />
...
<Image src="https://files.readme.io/80fec33-Number_of_store.png" />
...
<Image src="https://files.readme.io/4ff870b-Search_and_View.gif" />
...
<Image src="https://files.readme.io/48dd079-Edit_access_group.gif" />
...
<Image src="https://files.readme.io/af06d18-Deactivate.gif" />
