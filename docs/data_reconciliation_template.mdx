...
<Callout kind="info" title="Map multiple fields to identify the unique transaction">
...
<Image src="https://files.readme.io/23b6590-small-Processed_file.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/e9d107e-Transaction.gif" />
...
<Image src="https://files.readme.io/843479a-small-Status.png" />
...
2. In the filter header field, enter the heading **CAP_API_STATUS**. This is the status column header in the processed file of the reconciliation dataflow.
