...
| Neo Promote *(New)* | Grants permission to promote approved or live dataflows to mapped target organizations. This permission must be assigned in **both** the source and target organizations for a promotion to succeed. |  |
| **Data Management** | Data Import | Handle data import processes. |
| **Finance** | Finance Manager | Manage finance-related activities. |
| **Insights+** **Note**: At present, access to any one of the permission sets grants the user access to all modules within Insights+. Module-level access control is not enforced. | Insights+ Export/Segments/Settings | Export data, manage segments, and configure settings in Insights+. |
...
| Org Settings - Data Manager | Access for the following modules: Miscellaneous, Omni Channel Settings, Organization Setup, Master Data Management, Master Data Management, Tools, Gratification and Engagement, Customer Feedback System, Subscription Settings, Systems and Deployment, Product (Inventory), Communication and Gateway, Capillary Admin, Master Data Management, Organization Setup in organization settings. |  |
...
| ---------------------- | ---------------------------- | ---- | ------ | ----- |
| **OTHER_PERMISSIONS** | Ext Neo rule list view       | ✔    |        |       |
...
##### Assigning the Neo Promote permission set

1. Navigate to **User Management** &gt; **Permission Sets**.
2. Search for **Neo Promote** in the standard permission sets list.
3. Assign it to the relevant users in each organization where they perform or receive promotions.
...
## View masked PSI data

The VIEW_MASKED_DATA permission set controls whether a user can view [PSI data in the Member Care UI](https://docs.capillarytech.com/docs/masking-psi-fields#psi-masking-in-member-care). If a user does not have this permission set, PSI values are masked and displayed as XXXXX.

<Image src="https://files.readme.io/425563b1580fa4107e4f8cd3b43280a00830a728baf9317ef5879b488ab2238e-Screenshot_2026-01-21_at_4.12.07_PM.png" />
