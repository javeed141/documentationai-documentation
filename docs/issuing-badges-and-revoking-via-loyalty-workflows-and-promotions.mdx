...
<Image width="75%" src="https://files.readme.io/932d77c-image23.png" />
...
<Image width="75%" src="https://files.readme.io/7c497d0-Enable_comm_channel.png" />

5. In the communication channel creative, add the badge tags as required.

<Image width="75%" src="https://files.readme.io/73de350-Screenshot_2024-01-25_at_10.23.09_PM.png" />
...
<Image width="400px" src="https://files.readme.io/2d5d7d6-image37.png" />

The badge is claimed and added to the workflows.

<Image width="75%" src="https://files.readme.io/921a350-image6.png" />

7. Click **Save & Continue** to save the changes and publish the program.

<Image src="https://files.readme.io/437d65c-image25.png" />
