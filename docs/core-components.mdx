...
<Image src="https://files.readme.io/1abed2b6d7f2810702500222d1fe6fa7b37b2a346d8a998f86293f28b61f285f-Connected_Orgs.jpg" />
...
<Image width="55% " src="https://files.readme.io/443fa5d1ea04a8ef0951b86173331aedf7680479139b81cb628598ae4197c5bf-Screenshot_2025-06-23_at_2.15.15_PM.png" />
...
<Image width="55% " src="https://files.readme.io/22366220421cd7299575e00fa8b8c0809306d0ff078bef1afa450086c7d40425-Claim_Now_2.png" />
...
<Image width="55% " src="https://files.readme.io/22b7121c159782d952ed3cc12651b304bd07d88eda9d1fcef00cc770eff185cd-Claim_Now_5.png" />
...
<Image src="https://files.readme.io/a15500d187db1a4a9d2c1c2b4b7c2c67f401b65347310e55bdb1e04cace9ee20-Screenshot_2025-06-23_at_2.34.27_PM.png" />
...
The Rewards + platform supports analytics for various purposes, including understanding customer behaviour, customer navigation and preferences, troubleshooting and generating reports.\
...
| Feature | UI Click Based Analytics | Application Level Analytics |
| --- | --- | --- |
| **Tool/Mechanism** | Primarily uses Matomo. | Captures defined events on customer actions. |
| **What is Tracked** | Tracks customer interactions specifically on the UI. This includes: | Tracks specific, defined events that occur at the application backend level. |
| **Data Detail** | Provides very in-depth and very minute data. | Provides data focused only on the defined events |
| **Data Location** | The entire dataset is maintained within the Matomo database. | Stored in the Rewards+ database. |
| **Data Accessibility** | Ingress and output from Matomo. | Data is available in the database and is exposed to Tableau for reporting. |
| **Primary Use Cases** | * Understanding detailed UI interactions. | * **Reporting and analysis**. |
| * Viewing customer journey as a funnel. | * Utilized for **triggering certain actions** or calling different services based on the event name. |  |
| * Serves as a key input for the **personalization engine** (customer clicks, visits). | * Serves as input for the **personalization engine** (application level events). |  |
