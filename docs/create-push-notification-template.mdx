...
<Image src="https://files.readme.io/da9812c225e4de3ae21883e2502e1a72815fbf8a7b400266d7cbf7c688767a2c-Push_Notification_Flow.png" />
...
2. Select the **Mobilepush Account** to send the content.
   ...
   <Image width="80% " src="https://files.readme.io/c4ad2e7-image.png" />
...
4. Enter the following information for the push notification. The fields are as follows:
   ...
   <Image width="80% " src="https://files.readme.io/77cd8b3f5398141f8684114e8cab02d0b384de2278b17fba7033e32ec29671f2-image.png" />
...
7. To add a link that opens when a user selects the notification body, select **Action on click of notification body**. It is recommended to either add an action on click or a call to action button.
   ...
   3. For an External Link, enter the URL.
      ...
      <Image width="80% " src="https://files.readme.io/f78c959f55aa8a956f2f9df3f77168b6e3a9eb317c17b0b38522110d3027d35e-image.png" />
8. Select **+ Add primary button** to add a call-to-action (CTA) button to the push notification message. You can add one primary CTA button per template. It is recommended to either add an action on click or a call to action button.
   ...
   6. Select **Save** to add the button or **Delete** to discard your changes.
      ...
      <Image width="80% " src="https://files.readme.io/23a244167eb04bc9fbb8d7e7a0f694486a68eade05a3d8001671aaf617ab6548-image.png" />
...
10. (Optional) Select **[Preview and Test](https://docs.capillarytech.com/docs/test-and-preview-across-engagement-channels)** to preview the message content and test it with a set of [test customers](https://docs.capillarytech.com/docs/configure-campaign-level-settings#test-customers) before sending it.
...
| **Media type** | **Description** | **Format and size information** |
| --- | --- | --- |
| **Image** | Include a static image in the push notification message. | **Dimensions:** Up to 2048 × 2048 pixels. **Formats:** JPEG, JPG, PNG **GIF** is unsupported. |
| **Video** | Include a video in the push notification message. | **Formats:** 3GP, MP4, MOV, M4V. **Duration:** Up to 600 seconds. **File size:** Up to 200 MB. |
| **Carousel** | Include multiple static images in the push notification message. Carousel videos and actions for each carousel are unsupported. | **Dimensions:** Up to 2048 × 2048 pixels. **Formats:** JPEG, JPG, PNG. **Count:** Up to 10 individual images. |
