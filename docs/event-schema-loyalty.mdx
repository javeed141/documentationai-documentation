...
<CodeGroup tabs="Fixed window,Cyclic Window">
...
<CodeGroup tabs="via transaction,Non webhook payload,Good will points">
...
<CodeGroup tabs="Webhook payload,Points unlock API,Delayed accrual job,Via Transaction Add">
...
```json Webhook payload
{
  ...
  "orgId": 100737,
  "eventId": "b93f8f00-b1e8-4b51-a18f-231905de5541"
}
```
...
<CodeGroup tabs="Non webhook payload,Via thrift (API-Immediate),via Points Expiry Batch (Scheduled job)">
