...
<Image width="15% " src="https://files.readme.io/17c930d-Authentication.png" />
...
<Image width="40% " src="https://files.readme.io/f690f6e-Access.png" />
...
7. Select the **Allow access to sensitive information** checkbox if you want to allow the API client to access unmasked PSI data. If you leave this option disabled, API responses return PSI fields as masked when you use the OAuth token. This behaviour applies only [when organization-level PSI masking is enabled](https://docs.capillarytech.com/docs/introduction-datamasking#enabling-data-masking).
   ...
   <Image width="35% " src="https://files.readme.io/6a0d8a2f1245d43a3baddeb32f1b7e884f07c3c1e038d955fcc8d54f1cbe0c22-image.png" />
...
<Image width="40% " src="https://files.readme.io/ac9b19c-Select_access_group.png" />

11. Click **Next**. The Client key and Client secret are generated for the client.

<Image width="40% " src="https://files.readme.io/11dd3fd-clie.png" />
