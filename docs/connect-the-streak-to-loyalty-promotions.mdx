...
2. (currentEvent.StreakName=="Streak level name" and  and currentEvent.isStreakAchievedEvent), this rule helps in configuring different benefits for achieving the different levels in the streak.
...
5. Under the "Milestones/Streak" and "Targets(s)" section of the target-point allocation action:
   ...
   <Image src="https://files.readme.io/79f87b8-Workflow.png" />
