...
| :------------------------------------------------------------------------------------------------------------------ |
| Expression: **currentUserGroup.name.contains("Corporate") and  and currentUserGroup.createdDate.isAfter(2024,5,1,0,0,0)** |

| Example 2: Write a rule to check if the user group has an external ID and the name is not null |
| :--------------------------------------------------------------------------------------------- |
| Expression: **currentUserGroup.externalId.exists() and  and currentUserGroup.name.isNotNull(true)**  |
