...
2. Click **Advanced Filter**.
   ...
   <Image width="100% " src="https://files.readme.io/5b9def1-Advanced_filter_Button.png" />
...
<Image width="25% " src="https://files.readme.io/95c60ec-KPI_Dropdown.png" />
...
<Image width="25% " src="https://files.readme.io/0ab9909-Dimensions_Dropdown.png" />

5. Click **Apply**.

<Image width="75% " src="https://files.readme.io/1c661ae-Total_Screen.png" />
