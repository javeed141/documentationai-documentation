...
1. Navigate to **Settings &gt; Public keys &gt; Add new public key**.
   ...
   <Image src="https://files.readme.io/d7d4c06-Add_new_public_key.png" />
...
3. Click **Done**. A maximum of five keys can be added.
   ...
   <Image src="https://files.readme.io/9c7ffa4-Add_key.png" />
...
<Image src="https://files.readme.io/56476ad-Edit_key.png" />
