...
| :--- |
| Profile -> currentCustomer Attributes -> currentPoints And -> and  and Expression : currentCustomer.currentPoints>=1000 and  and (currentCustomer.currentPoints<5000 |

| Example 3: Write an expression to Issue a Coupon to the customers whose Condition1 : current Transaction value is greater than 500 Condition 2: Current Transaction Basket Includes the item from category field, value lifestyle Condition 3 : Current Points is greater than 400 Also Condition 1 AND condition 2 OR Condition 3 |
| :--- |
| Ans: Profiles Included for Current Transaction -> currentTxn Profiles Included for Current Points -> currentPoints AND -> and  and OR -> || Expression:(currentTxn.value>500) and  and (currentTxn.basketIncludes(“Category”,”Lifestyle”))||currentCustomer.currentPoints>400 |
...
| :------------------------------------------------------------------------------------------------------------------------------------------------- |
| Expression: (currentCustomer.initialLifetimePoints==currentCustomer.initialCurrentPoints) and  and (currentCustomer.numberOfTxns==1)                       |
...
| :----------------------------------------------------------------------------------------------------------------------------------- |
| currentCustomer.lifetimePoints>500 and  and (currentTxn.basketIncludes("Product","Shirt"))                                                   |
...
| :--- |
| OR -> || Profile for lifetimePoints : currentCustomer Profile for Transaction: currentTxn Rule -> currentCustomer.lifetimePoints >= 50||currentTxn.value >500 |
...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| (currentCustomer.LifetimeNonRedeemablePoints==currentCustomer.initialCurrentPoints) and  and (currentCustomer.numberOfTxns==1)                                                  |

| Example : Write an expression to Issue a Coupon to the customers whose Condition1 : current Transaction value is greater than 500 Condition 2: Current Transaction Basket Includes the item from category field, value lifestyle Condition 3 : lifetime Non Redeemable Points Also Condition 1 AND condition 2 OR Condition 3 |
| :--- |
| Expression:(currentTxn.value>500 and  and (currentTxn.basketIncludes(“Category”,”Lifestyle”))||currentCustomerLifetimeNonRedeemablePoints>400 |
...
| :-------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rule :(currentCustomer.lifetimeAllPoints==currentCustomer.initialCurrentPoints) and  and (currentCustomer.numberOfTxns==1)                                  |
...
| :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Rule: (currentCustomer.currentPoints>200 and  and (currentCustomer.currentPoints>500))||currentcustomer.initiallifetimePoints>100                             |
