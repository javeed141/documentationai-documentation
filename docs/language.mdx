...
<Image src="https://files.readme.io/ab773a0-C9gcSvVsJUKNqSJRg_rPxOvmtP0rAsBEOA.png" width="1920" height="1080" alt="" />

2. Click **Tools > Localize.**
3. Select **Cart Promotions**.

<Image src="https://files.readme.io/86665a4-h0b_ZHuSdIaGuM-tPNZMPOM7pOSt6gjQdA.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/1f1dea3-h0b_ZHuSdIaGuM-tPNZMPOM7pOSt6gjQdA.png" width="1920" height="1080" alt="" />
...
| Request Type | GET |
| --- | --- |
| Headers | Content-Type: application/json\ X-CAP-API-AUTH-ORG-ID: \{\{orgId\}\}\ Authorization: \{\{basic auth\}\}\ Accept-Language: \{\{languagecode\}\} |
| Headers | Content-Type: application/json\ X-CAP-API-AUTH-ORG-ID: \{\{orgId\}\}\ Authorization: \{\{basic auth\}\}\ Accept-Language: \{\{languagecode\}\} |
...
<Image src="https://files.readme.io/1e671eb-cqRWMVBfvL7MmkMS__p-Ml2rAHtPdh625g.png" width="1920" height="1080" alt="" />

2. Click on the product for which you want to add translations.
3. Click on the + icon to add a new language.

<Image src="https://files.readme.io/6c5a91c-L0uNxuHRuBly3wLPVM6uHvYj6ZALgKpX8Q.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/d0b5d38-7mhpk8xfwBmg8lUnU3S8Iui4eaKxg4fHPA.png" width="1920" height="1080" alt="" />

5. Click Save. You will see the new language as shown below.

<Image src="https://files.readme.io/edf2ec7-zEMwLuf5QD9-ejaUbksNb-kBgl066inaXg.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/95421cc-wqNhJJimVXxsTVBPRfGH5TZfwS4DVK-_qg.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/71537a9-OxXFWQVct6nUiCmYAXHKc1byGHJa8QKlCw.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/45611b2-8LcEAxn9G0E7oy1YFgNbcGvGiQviZvx9KQ.png" width="1920" height="1080" alt="" />
