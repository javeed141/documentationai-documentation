...
<Image width="80%" src="https://files.readme.io/d554f5e-jNXxmLv6XStl8huxbwBSmkH1xfX_djWo5Q.png" />

3. Click on **Create new**.
4. In the **Journey name** text box, enter a name for your journey.

<Image width="80%" src="https://files.readme.io/d824f1d-EK5zAdphdgI-0WcrnqNnaXQGgYfZAgtpLw.png" />
...
<Image width="70% " src="https://files.readme.io/108a742-Enrol_Issue_badge.png" />
...
* Only Enrol and Issue badges can be created when enrolling customers to badges, and owner type can be any.
...
<Image src="https://files.readme.io/b546928-Select_badge.png" />
...
3. To include information about the badges in the message, select **Add Creatives** > Select template > **Add label** > **Badge** and select the desired tags. If you have added multiple badges, you need to include multiple tags. For example, the expiry information of each badge. If the badges do not have any expiry, select No expiry tags.
   ...
   <Image width="40% " src="https://files.readme.io/17c2007-Add_label.png" />
