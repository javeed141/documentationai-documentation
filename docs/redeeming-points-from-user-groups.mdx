...
<Image width="300px" src="https://files.readme.io/f018673-screen-capture_4.gif" />
...
3. In Loyalty side in the redemption event, write the rule for the group and configure redeem points action.
   1. If "Friends and Family" group is enabled, choose the redemption options from the Advance settings, and enable redemption.
...
<Image src="https://files.readme.io/2b71bf0-Screenshot_2023-07-18_at_11.59.02_AM.png" />

<Image src="https://files.readme.io/8392395-Screenshot_2023-07-18_at_12.04.55_PM.png" />
...
5. If either of the user_group2_primary_user_id or user_group2_id or user_group2_external_id is not null, the transaction will be treated as group loyalty redemption.
