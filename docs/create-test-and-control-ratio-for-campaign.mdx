...
<Image width="70% " src="https://files.readme.io/beb993a-qub-5jTprqNPKBzX6jBMbjLnyRybd2rapQ.png" />
...
* Campaign level: Different campaigns will have different test and control audiences. Recommended for short (campaign) duration, to track the performance of a particular campaign.

<Callout kind="info" title="Note">

We recommended you use either campaign level test and control or org level test and control. If you use both methods, the result data will not be effective.

</Callout>

### Configure test and control ratio

#### Organization level test and control ratio
...
The Org level test and control settings is configured successfully.

<Image width="90% " src="https://files.readme.io/1b366f3d12a3497cfd99c3f8624682664a911764571ede1c92f3c1b63f31a993-Gif_2.gif" />
...
<Image width="smart" src="https://files.readme.io/c4dcd8c-kR5lu1G7btYgkXbnBV-hNjuLwSjJOxBGtQ.png" />
...
<Image width="smart" src="https://files.readme.io/0a0b6e3-2930-2D2zQpGfjmj7bDv-LJNU3bgbZ7R4A.png" />
