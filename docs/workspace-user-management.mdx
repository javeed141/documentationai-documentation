...
<Image width="65% " src="https://files.readme.io/18c1251-gear.gif" />

2. Enter the name of the workspace.

<Image width="65% " src="https://files.readme.io/5c8c9e6-name.gif" />

3. From the drop-down, select the appropriate region/cluster and organization.

<Image width="65% " src="https://files.readme.io/b87fa21-save_workspace.gif" />

4. Click **Done**

<Image width="65% " src="https://files.readme.io/a9e7942-done.gif" />

The created workspace is created on the workspace's home page.

<Image width="65% " src="https://files.readme.io/dab7613-displ.gif" />
...
<Image width="65% " src="https://files.readme.io/971b4b3-edit.gif" />

3. From the drop-down, select the appropriate region/cluster and organization.

<Image width="65% " src="https://files.readme.io/4e9cbdf-edit_works.gif" />

4. Click **Done**.

<Image width="65% " src="https://files.readme.io/35650f3-done_work.gif" />
...
<Image width="65% " src="https://files.readme.io/2cdb551-delete.gif" />
...
<Image width="65% " src="https://files.readme.io/6a5f2b7-navi_user.gif" />

3. Click on **Add User**.

<Image width="65% " src="https://files.readme.io/6f8b63b-user.gif" />

4. Enter the name, and email ID of the user.

<Image width="65% " src="https://files.readme.io/c631a18-name_email.gif" />

5. Assign the role from the **Role** dropdown.

<Image width="65% " src="https://files.readme.io/2638801-role.gif" />

6. Assign the workspace applicable to the user.

<Image width="65% " src="https://files.readme.io/c15c14c-access_work.gif" />

7. Click **Done**.

<Image width="65% " src="https://files.readme.io/b38f05a-click_done.gif" />

8. You can view the newly added user on the **Users** page.

<Image width="65% " src="https://files.readme.io/128018d-add_user.gif" />
...
<Image width="65% " src="https://files.readme.io/cbcb761-3dot.gif" />

4. Click **Edit**.

<Image width="65% " src="https://files.readme.io/fe3f1a2-edit.gif" />

5. Edit user name, role or workspace as required.

<Image width="45% " src="https://files.readme.io/0dc28c2-Edit_user.png" />

6. Click **Done**.

<Image width="65% " src="https://files.readme.io/6965b4b-done.gif" />
...
<Image width="65% " src="https://files.readme.io/9a003b6-del_user.gif" />

5. Click **Yes, Delete**.

<Image width="65% " src="https://files.readme.io/8198896-yes_del.gif" />
